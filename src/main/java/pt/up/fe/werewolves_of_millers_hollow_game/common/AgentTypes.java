...
public enum AgentTypes {
	...
	public static final AgentTypes[] PLAYERS = { VILLAGER, WEREWOLF, FORTUNE_TELLER };
	...
	static {
		...
		// typesToBehaviours.put(FORTUNE_TELLER, agent -> new
		// FortuneTellerBehaviour((Player) agent));
	}
